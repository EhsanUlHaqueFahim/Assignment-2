            ...
            <div className='relative text-center py-20 px-4'>
                <div className='flex flex-col gap-10 max-w-5xl mx-auto'>
                    <div className='space-y-6'>
                        <span className='inline-flex items-center px-6 py-3 rounded-full bg-white/80 backdrop-blur-sm border border-purple-200 text-[#6A38C2] font-semibold text-sm shadow-lg'>
                    ...
                    <div className='flex w-full max-w-3xl shadow-2xl border border-gray-200 pl-8 rounded-full items-center gap-4 mx-auto bg-white/90 backdrop-blur-sm'>
                        <input
                            type="text"
                            placeholder='Search for jobs, companies, or skills...'
                            onChange={(e) => setQuery(e.target.value)}
                            className='outline-none border-none w-full py-6 text-lg bg-transparent'
                        />
