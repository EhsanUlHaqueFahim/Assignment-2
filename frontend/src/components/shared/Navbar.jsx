...
const Navbar = () => {
    ...
    return (
        <div className='bg-white dark:bg-gray-900 shadow-sm border-b border-gray-100 dark:border-gray-800 sticky top-0 z-50'>
                ...
                <div className='flex items-center gap-8'>
                    ...
                    </ul>
                    {
                        loading ? (
                            ...
                            <div className='flex items-center gap-3'>
                                <Link to="/login"><Button variant="outline" className="hover:bg-gray-50 dark:hover:bg-gray-800">Login</Button></Link>
                            ...
                            <Popover>
                                ...
                                <PopoverContent className="w-80 shadow-lg border border-gray-200 dark:border-gray-700 dark:bg-gray-800">
                                    <div className='p-4'>
                                        ...
                                        <div className='flex flex-col space-y-2 text-gray-600 dark:text-gray-300'>
                                            {
                                                user && user.role === 'student' && (
                                                    <Link to="/profile">
                                                        <div className='flex items-center gap-2 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded-md transition-colors'>
                                            ...
                                            <div className='flex items-center gap-2 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded-md transition-colors' onClick={logoutHandler}>
