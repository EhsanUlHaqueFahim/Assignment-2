...
const Footer = () => {
  return (
    <footer className="border-t border-t-gray-200 dark:border-gray-700 py-8 bg-white dark:bg-gray-900">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold text-gray-900 dark:text-white">WorkNest</h2>
            <p className="text-sm text-gray-600 dark:text-gray-400">© 2025 Your Company. All rights reserved.</p>
          </div>
          
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://facebook.com" className="hover:text-gray-400 dark:text-gray-300 dark:hover:text-gray-400" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="hover:text-gray-400 dark:text-gray-300 dark:hover:text-gray-400" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="hover:text-gray-400 dark:text-gray-300 dark:hover:text-gray-400" aria-label="LinkedIn">
