    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-purple-50 to-pink-100">
            ...
            <div className='flex items-center justify-center max-w-7xl mx-auto px-4'>
                <form onSubmit={submitHandler} className='w-full max-w-lg bg-white shadow-xl border border-gray-200 rounded-xl p-8 my-10'>
                    <h1 className='font-bold text-3xl mb-6 text-center text-gray-800'>Join WorkNest</h1>
                    <div className='my-2'>
