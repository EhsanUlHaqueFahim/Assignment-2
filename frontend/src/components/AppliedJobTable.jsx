...
const AppliedJobTable = () => {
    ...
    return (
        <div className="p-8">
            <Table>
                <TableCaption className="text-gray-600 dark:text-gray-400">A list of your applied jobs</TableCaption>
                <TableHeader>
                    <TableRow>
                ...
                <TableBody>
                    {
                        allAppliedJobs.length <= 0 ? <span className="text-gray-500 dark:text-gray-400">You haven't applied any job yet.</span> : allAppliedJobs.map((appliedJob) => (
