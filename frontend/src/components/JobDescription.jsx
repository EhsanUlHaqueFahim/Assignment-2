...
const JobDescription = () => {
    ...
    return (
        <div className='min-h-screen bg-gray-50 dark:bg-gray-900'>
            ...
            <div className='flex items-center justify-between'>
                <div>
                    ...
                    <div className='flex items-center gap-2 mt-4'>
                        ...
                        <Badge className={'text-[#7209b7] dark:text-purple-400 font-bold'} variant="ghost">{singleJob?.salary} Taka</Badge>
                    </div>
                </div>
                <Button
            ...
            <h1 className='border-b-2 border-b-gray-300 dark:border-gray-600 font-medium py-4 text-gray-900 dark:text-white'>Job Description</h1>
            <div className='my-4'>
                ...
                <h1 className='font-bold my-1 text-gray-900 dark:text-white'>Salary: <span className='pl-4 font-normal text-gray-800 dark:text-gray-300'>{singleJob?.salary} Taka</span></h1>
