...
const UpdateProfileDialog = ({ open, setOpen }) => {
    ...
    return (
        <div>
            <Dialog open={open}>
                <DialogContent className="sm:max-w-[425px] dark:bg-gray-800 dark:border-gray-700" onInteractOutside={() => setOpen(false)}>
                    <DialogHeader>
                        <DialogTitle className="text-gray-900 dark:text-white">Update Profile</DialogTitle>
                    </DialogHeader>
